      ...
      <div className="flex items-center justify-between">
        ...
        {preview && (
          <button
            onClick={handleClear}
            disabled={disabled}
            className="text-[10px] font-bold text-rose-600 hover:text-rose-700 transition-colors disabled:opacity-30 cursor-pointer"
          >
            ✕ Clear
          </button>
        )}
      ...
      {preview ? (
        ...
        <div className="relative group">
          <div className="flex items-center gap-3 p-2.5 rounded-xl bg-slate-50 border border-slate-200">
            {/* Thumbnail */}
            <div className="relative w-14 h-14 rounded-lg overflow-hidden flex-shrink-0 border border-slate-200">
            ...
            <button
              ...
              className="
                ...
                rounded-lg border border-slate-200 hover:border-slate-350
        ...
        <div
          ...
          className={`
            ...
            ${disabled
              ? "opacity-30 cursor-not-allowed border-slate-100 bg-transparent"
              : isDragging
                ? "border-indigo-500/50 bg-indigo-50/20 scale-[1.01]"
        ...
        >
          ...
          `}>
            <svg
              className={`w-4 h-4 transition-colors ${isDragging ? "text-indigo-600" : "text-slate-400"}`}
