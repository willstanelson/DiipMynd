        ...
        headers: [
          {
            ...
            value: [
              ...
              "connect-src 'self' https://accounts.google.com https://*.supabase.co https://*.fal.run wss://*.fal.run https://api.paystack.co https://api.telegram.org http://localhost:8000 https://api.decart.ai https://*.runwayml.com",
